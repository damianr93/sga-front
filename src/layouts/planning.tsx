...
const iso = [
  ...
  { primary: '4.2 Partes Interesadas', secondary: 'Descripción de las partes interesadas' },
  { primary: '4.3 Alcance del SGA', secondary: 'Descripción del alcance del SGA' },
  { primary: '4.4 Establecimiento de Procesos', secondary: 'Descripción del establecimiento de procesos' },
  { primary: '6.1 Acciones para abordar riesgos y oportunidades', secondary: 'Descripción de acciones para abordar riesgos y oportunidades' },
  { primary: '6.1.2 Aspectos ambientales', secondary: 'Descripción de los aspectos ambientales' },
